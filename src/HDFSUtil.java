...
//        //download test
//        HDFSUtil.DowloadFromHDFS(conf,"/user/hadoop/b.mp4","d:\\c.mp4");
//        System.out.println("下载成功！");

//        HDFSUtil.UploadLocalFileHDFS(conf,"d:\\c.mp4","/user/hadoop/");
//        //05. 测试获取所有目录信息
//        FileStatus[] dirs2 = HDFSUtil.listStatus(conf, "/user/hadoop");
//        System.out.println("--根目录下的所有子目录---");
